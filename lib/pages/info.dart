            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  Text("VITO is een Vlaamse onafhankelijke onderzoeksorganisatie op het gebied van cleantech en duurzame ontwikkeling.", textAlign: TextAlign.center),
                  Text("\nOns doel?\nDe transitie versnellen naar een duurzame wereld.", textAlign: TextAlign.center),
                  SizedBox(
                    height: 40,
                  ),
                  ...
                  Text("Een groep van 6 enthousiaste studenten die trachten een top project af te leveren. Een project waar zowel VITO, de opleiding alsook wij meer als tevreden zijn met het eindresultaat.", textAlign: TextAlign.center),
                  IntrinsicHeight(
                    child: Row(
                    children: [
                      Expanded(
                      ...
                      children: [
                        ...
                        Text("Youri Van Laer", textAlign: TextAlign.center),
                      ],
                    ),
                        ),
                      ),
                      ...
                      children: [
                        Image(
                          image: AssetImage("assets/ArnoVangoetsenhoven.png"),
                          height: 120,
                        ),
                                                SizedBox(
                          height: 5.0,
                        ),
                        Text("Arno Vangoetsenhoven", textAlign: TextAlign.center),
                      ],
                    ),
                        ),
                      ),
                    ...
                    children: [
                      ...
                      children: [
                        ...
                        Text("Senne Van Pelt", textAlign: TextAlign.center),
                      ],
                    ),
                        ),
                      ),
